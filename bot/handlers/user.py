...
def register_user_handlers(dp):
    ...
    async def cmd_start(message: types.Message, state: FSMContext):
        ...
        caption = (
            ...
            "🤖 <b>Podzemka Bot</b> — бот для настоящих шахтеров.\n\n"
            "💎 <b>Что делает бот?</b>\n"
            "• Принимает заявку на доступ\n"
            "• После одобрения открывает доступ к <b>скриптам</b>\n"
            "• Сейчас доступен скрипт для <b>Шахты</b>: подсчет ресурсов, таймеры и удобные фишки\n\n"
            "🚀 <b>В будущем:</b>\n"
            "Будут появляться новые скрипты и инструменты для других задач.\n\n"
            "👇 <b>Главное меню:</b>"
        )
